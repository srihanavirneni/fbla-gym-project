            ...
            <div className="testimonials-list__wrapper">
                <FakeTweet
                    config={{
                        ...
                        display: 'default',
                        text: "Our youth basketball tournament at West Virginia High's gym was a big success, with plenty of seating and easy navigation for everyone. The rental process was smooth, and we’ll definitely use this space again!",
                        image: '',
                ...
                <FakeTweet
                    config={{
                        ...
                        display: 'default',
                        text: "The community concert at West Virginia High's gym exceeded our expectations, with fantastic acoustics and comfortable seating. Setup was a breeze thanks to the rental team, and we can’t wait to return!",
                        image: '',
