        ...
        <div className="home__about-info">
            ...
            <div className="about-info__content">
                ...
                <p>
                    ...
                    {import.meta.env.VITE_SCHOOL_NAME} that is dedicated to
                    providing an outstanding space for athletics, performances,
                    and large-scale events. Our state-of-the-art gymnasium is
                    more than just a place for sports—it's a versatile venue
                    that brings people together for concerts, graduations,
                    community gatherings, and whatever you can imagine.
                </p>
