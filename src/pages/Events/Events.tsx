    ...
    const ITEMS = [
        {
            ...
            location: 'Stadium',
            description:
                'Annual homecoming game between West Virginia High School and Rivals High School',
            ticketCost: 20,
            eventOrganizers: 'WVHS Athletics Department',
        ...
        },
        {
            ...
            ticketCost: 35,
            eventOrganizers: 'WVHS Student Council',
        ...
        },
        {
            ...
            ticketCost: 20,
            eventOrganizers: 'WVHS Music Department',
